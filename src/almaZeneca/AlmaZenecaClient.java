...
public class AlmaZenecaClient extends TablutClient {
    ...
    public AlmaZenecaClient(String player, String name, int timeout, String ipAddress, int game) throws UnknownHostException, IOException {
    ...
    public static void main(String[] args) throws IOException {
        ...
        AlmaZenecaClient client = new AlmaZenecaClient(role, name, timeout, ipAddress, gameType);
        client.run();
    }
