...
public final class Minmax implements Callable<Action> {
    ...
    @Override
    public Action call() throws Exception {		//QUSTA è LA FUNZIONE CHE VIENE CHIAMATA DAL THREAD

        //valore del risultato
        double resultValue = Double.NEGATIVE_INFINITY;

        //azioni iniziali
        List<Action> azioni = u.getSuccessors(currentState);	//elabora lista possibili azioni
        Collections.shuffle(azioni);							//mischia la lista
